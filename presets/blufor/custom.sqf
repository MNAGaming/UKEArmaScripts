...
plane_typename = "B_Plane_Fighter_01_F";								//carrier plane
uav_typename = "B_UAV_05_F";											//carrier ucav
rover_typename = "B_T_MRAP_01_F";										//carrier tow vehicle																	Default is "B_Heli_Transport_03_unarmed_F".
