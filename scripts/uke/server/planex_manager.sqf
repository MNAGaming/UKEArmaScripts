...
planex2 = _spawnName;
_trigger setTriggerStatements["{_x isKindOf 'B_Slingload_01_Ammo_F'} count thisList > 0","[planex2] call FNC_REMOTE_ACTIVATE","[planex2] call FNC_REMOTE_DEACTIVATE"];
